...
public class Ejercicio1 {
    // Ruta corregida según la ubicación del archivo
    private static final String RUTA_ARCHIVO = "src/tema7/Ficheros/funkos.csv";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(RUTA_ARCHIVO))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (partes.length == 5) {
                    ...
                    LocalDate fecha = LocalDate.parse(partes[4], FORMATTER);
