...
public class Tema1Ejercicio5 {
    public static void main(String[] args) {
        ...
        System.out.println("13.  10 + 4 < 15 - 3 OR 2 * 5 + 1 > 14 - 2 * 2= " + op13);
        boolean op14 = 4*2<=8||2*2<5&&4>3+1;
        System.out.println("14.  4 * 2 <= 8 OR 2 * 2 < 5 AND 4 > 3 + 1= " + op14);
